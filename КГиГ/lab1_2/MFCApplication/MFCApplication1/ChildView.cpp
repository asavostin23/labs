...
CChildView::CChildView()
{
	...
	SetValueMatrixWithIncrement(*B, 4, 0.2);
	SetValueMatrixWithIncrement(*V1, 6, 2);
	SetValueMatrixWithIncrement(*V2, 8, 1);
	SetValueMatrixWithIncrement(*P1, 0.2, 0.1);
	/*(*P1)(0, 0) = 5;
	(*P1)(1, 0) = 30;
	(*P1)(2, 0) = 45;*/
...
void CChildView::PrintVectorsClick()
{
	...
	CDC* dc = GetDC(); //чтобы вызывать метод textout
