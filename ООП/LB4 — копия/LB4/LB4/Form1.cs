...
namespace LB4
{
    ...
    {
        public StateZero(Calculator calc) => base.SetCalc(calc);
    ...
    {
        public StateTwo(Calculator calc) => base.SetCalc(calc);
        public override void PrintDigit(int num)
        {
    ...
    {
        public StateThree(Calculator calc) => base.SetCalc(calc);
        public override void PrintDigit(int num)
        {
            calc.PrintNumber(calc.GetNumber() * 10 + num);
        }
    ...
    public partial class Form1 : Form
    {
        ...
        public int GetTextBox() => int.Parse(this.textBox1.Text);
