...
namespace LB5_2
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1(Form4 form4) : this() => callingForm = form4;
        public Form1(Form4 form4, Subject subject) : this(form4)
        {
            this.subject = subject;
            GetInfoFromSubject(subject);
        }
        public Form4 callingForm;
        ...
        private void SubjectSaveButton_Click(object sender, EventArgs e)
        {
            ...
            //    sw.WriteLine(json);
            //}
            ////callingForm.subjects.Add(subject);
            callingForm.subjectsCopy.Add(subject);
            callingForm.RestoreSubjectsFromCopy();
        ...
        private void GetInfoFromSubject(Subject subject)
        {
